module PetstoreApp
  module Actions
    module Pets
      class GetPetById < PetstoreApp::Action
        def handle(request, response)
          request_validation_result = Contracts::GetPetByIdRequestContract.new.call(request.params.to_h)
          ...
          service_result = GetPetByIdService.new.call(params)
