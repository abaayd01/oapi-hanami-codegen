module PetstoreApp
  module Actions
    module Pets
      class GetAllPets < PetstoreApp::Action
        def handle(request, response)
          request_validation_result = Contracts::GetAllPetsRequestContract.new.call(request.params.to_h)
          ...
          service_result = GetAllPetsService.new.call(params)
