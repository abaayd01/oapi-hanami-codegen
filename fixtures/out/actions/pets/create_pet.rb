module PetstoreApp
  module Actions
    module Pets
      class CreatePet < PetstoreApp::Action
        def handle(request, response)
          request_validation_result = Contracts::CreatePetRequestContract.new.call(request.params.to_h)
          ...
          service_result = CreatePetService.new.call(params)
